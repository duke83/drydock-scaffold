...
function renderHandler(name, pathToFixture, isJson, statusCode,OTHER) {
  ...
  var sucTmpl = successTmpl({ NAME: t.stringLiteral(name), FIXTURE_EXPRESSION: FIXTURE_EXPRESSION, OTHER:t.stringLiteral(OTHER) }) ;
